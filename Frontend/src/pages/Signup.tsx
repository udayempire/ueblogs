...
import { signupInput } from "@udayempire/ueblogs/dist"
...
export const Signup = () => {
    ...
    async function sendRequest() {
        try {
            ...
            if(err.response){
                const errMessage = err.response.data.error || "An error Occurred"
                alert(errMessage)
            }else{
    ...
    return <div>
        <div className="grid grid-cols-1 md:grid-cols-2 w-screen h-screen  bg-zinc-50   ">
            <div className="flex flex-col w-full h-full justify-center items-center gap-4">
                ...
                <Button className="max-w-xs md:max-w-sm w-full" variant="outline">
                ...
                <div className="grid w-full max-w-xs md:max-w-sm items-center gap-1.5">
                    ...
                    <Input type="password" id="password" placeholder="Create a password" onChange={(e)=>{
                        setPostInputs({
                            ...postInputs,
