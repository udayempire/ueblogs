...
export const Signin = () => {
    return <div>
        <div className="grid grid-cols-2 w-screen h-screen  bg-zinc-50   ">
            <div className=" bg-cover bg-center h-screen" style={{ backgroundImage: "url('/nature.png')" }}>
            ...
            <div className="flex flex-col w-full h-full justify-center items-center gap-4">
                <div>
                    ...
                    <h3 className="font-medium text-slate-500 p-2 w-full max-w-sm">Not have an Account yet? <Link className="underline cursor-pointer hover:text-blue-700" to="/signup">Sign Up</Link></h3>
                </div>
                ...
                <p className="w-full max-w-lg text-center text-sm pt-5">
